    ...
    <>
      ...
      <div className="w-full max-w-3xl px-4">
        <Section>
          ...
          <Section.Body>
            At ActivityRank, accessible from activityrank.me, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by ActivityRank and how we use it. If you have additional
            ...
            ActivityRank. This policy is not applicable to any information
            collected offline or via channels other than this website and bot.
            Our Privacy Policy was created with the help of the Privacy Policy
            Generator and the Generate Privacy Policy Generator.
          </Section.Body>
        </Section>
        <Section>
          <Section.Header>Consent</Section.Header>
          <Section.Body>
            By using our website and bot, you hereby consent to our Privacy
            Policy and agree to its terms.
          </Section.Body>
        </Section>
        <Section>
          <Section.Header>Information we collect</Section.Header>
          <Section.Body>
        ...
        <Section>
          <Section.Header>How we use your information</Section.Header>
          <Section.Body>
            We use the information we collect in various ways, including to:
            <Section.BulletList>
              <Section.ListEntry>
                Provide, operate, and maintain our webste Improve, personalize,
                and expand our website and bot.
              </Section.ListEntry>
              <Section.ListEntry>
              ...
              <Section.ListEntry>Send you emails.</Section.ListEntry>
              <Section.ListEntry>Find and prevent fraud.</Section.ListEntry>
            </Section.BulletList>
          </Section.Body>
        </Section>
        <Section>
          <Section.Header>Log files</Section.Header>
          <Section.Body>
            ActivityRank follows a standard procedure of using log files. These
            files log visitors when they visit website and bot. All hosting
            ...
            website and bot, and gathering demographic information.
          </Section.Body>
        </Section>
        <Section>
          <Section.Header>Cookies and Web Beacons</Section.Header>
          <Section.Body>
            Like any other website, ActivityRank uses cookies. These cookies are
        ...
        <Section>
          <Section.Header>GDPR Data Protection Rights</Section.Header>
          <Section.Body>
        ...
        <Section>
          <Section.Header>Children&apos;s information</Section.Header>
          <Section.Body>
            Another part of our priority is adding protection for children while
            using the internet. We encourage parents and guardians to observe,
            participate in, and/or monitor and guide their online activity.
            ActivityRank does not knowingly collect any Personal Identifiable
            Information from children under the age of 13. If you think that
            your child provided this kind of information on our website and bot,
